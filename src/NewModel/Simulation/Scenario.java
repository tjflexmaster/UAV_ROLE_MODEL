...
//		Simulator.getInstance().addExternalEvent(new Event(EventType.ENV_HIGH_WIND, 500), 200);
//		Simulator.getInstance().addExternalEvent(new Event(EventType.UAV_BAD_PATH, 80), 120);
//		Simulator.getInstance().addExternalEvent(new Event(EventType.UAV_LOST_SIGNAL, 20), 120);
//		Simulator.getInstance().addExternalEvent(new Event(EventType.UAV_LOW_HAG, 120), 120);
...
//		Simulator.getInstance().addExternalEvent(new Event(EventType.PS_TERMINATE_SEARCH, 1), 120);
//		Simulator.getInstance().addExternalEvent(new Event(EventType.PS_NEW_AOI, 1), 300);
