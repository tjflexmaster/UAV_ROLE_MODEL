...
public class Team extends ArrayList<Actor> {
	...
	public Team() {
		...
		inputs.put(UDO.VGUI_FLYBY_REQ_T_OGUI.name(),UDO.VGUI_FLYBY_REQ_T_OGUI);
		inputs.put(UDO.VGUI_FLYBY_REQ_F_OGUI.name(),UDO.VGUI_FLYBY_REQ_F_OGUI);
		inputs.put(UDO.VGUI_FLYBY_END_SUCCESS_OGUI.name(),UDO.VGUI_FLYBY_END_SUCCESS_OGUI);
		inputs.put(UDO.VGUI_FLYBY_END_FAILED_OGUI.name(),UDO.VGUI_FLYBY_END_FAILED_OGUI);
		outputs.clear();
		...
		outputs.put(UDO.OGUI_FLYBY_END_UAV.name(),UDO.OP_FLYBY_END_UAV);
		outputs.put(UDO.OGUI_LAND_UAV.name(),UDO.OP_LAND_UAV);
		outputs.put(UDO.OGUI_LOITER_UAV.name(),UDO.OP_LOITER_UAV);
		...
		inputs.put(UDO.VGUI_FLYBY_ANOMALY_F_VO.name(),UDO.VGUI_FLYBY_ANOMALY_F_VO);
		inputs.put(UDO.VGUI_FLYBY_ANOMALY_T_VO.name(),UDO.VGUI_FLYBY_ANOMALY_T_VO);
		outputs.clear();
		...
		inputs.put(UDO.EVENT_TARGET_SIGHTED_F_VGUI.name(),UDO.EVENT_TARGET_SIGHTED_F_VGUI);
		inputs.put(UDO.EVENT_TARGET_SIGHTED_END_VGUI.name(),UDO.EVENT_TARGET_SIGHTED_END_VGUI);
		inputs.put(UDO.EVENT_TARGET_SIGHTED_T_VGUI.name(),UDO.EVENT_TARGET_SIGHTED_T_VGUI);
		inputs.put(UDO.EVENT_FLYBY_ANOMALY_F.name(),UDO.EVENT_FLYBY_ANOMALY_F);
		inputs.put(UDO.EVENT_FLYBY_ANOMALY_T.name(),UDO.EVENT_FLYBY_ANOMALY_T);
		inputs.put(UDO.VF_SIGNAL_OK_VGUI.name(),UDO.VF_SIGNAL_OK_VGUI);
		inputs.put(UDO.VF_SIGNAL_NONE_VGUI.name(),UDO.VF_SIGNAL_NONE_VGUI);
		outputs.clear();
		...
		outputs.put(UDO.VGUI_FLYBY_REQ_T_OGUI.name(),UDO.VGUI_FLYBY_REQ_T_OGUI);
		outputs.put(UDO.VGUI_FLYBY_REQ_F_OGUI.name(),UDO.VGUI_FLYBY_REQ_F_OGUI);
		outputs.put(UDO.VGUI_FLYBY_END_FAILED_OGUI.name(),UDO.VGUI_FLYBY_END_FAILED_OGUI);
		outputs.put(UDO.VGUI_FLYBY_END_SUCCESS_OGUI.name(),UDO.VGUI_FLYBY_END_SUCCESS_OGUI);
		...
		inputs.put(UDO.OP_TAKE_OFF_UAV.name(),UDO.OP_TAKE_OFF_UAV);
		inputs.put(UDO.OP_FLYBY_END_UAV.name(),UDO.OP_FLYBY_END_UAV);
		inputs.put(UDO.OP_LAND_UAV.name(),UDO.OP_LAND_UAV);
		inputs.put(UDO.OP_LOITER_UAV.name(),UDO.OP_LOITER_UAV);
		inputs.put(UDO.OGUI_MODIFY_FLIGHT_PLAN_UAV.name(),UDO.OGUI_MODIFY_FLIGHT_PLAN_UAV);
		inputs.put(UDO.OGUI_NEW_FLIGHT_PLAN_UAV.name(),UDO.OGUI_NEW_FLIGHT_PLAN_UAV);
		inputs.put(UDO.OGUI_RESUME_UAV.name(),UDO.OGUI_RESUME_UAV);
		...
		outputs.put(UDO.UAV_LOITERING.name(),UDO.UAV_LOITERING);
		outputs.put(UDO.UAV_LANDING.name(),UDO.UAV_LANDING);
		outputs.put(UDO.UAV_TAKE_OFF.name(),UDO.UAV_TAKE_OFF);
		outputs.put(UDO.UAV_LANDED.name(),UDO.UAV_LANDED);
		outputs.put(UDO.UAV_READY.name(),UDO.UAV_READY);
		outputs.put(UDO.UAV_FLIGHT_PLAN_COMPLETE.name(),UDO.UAV_FLIGHT_PLAN_COMPLETE);
		...
		outputs.put(UDO.UAV_FLIGHT_PLAN_NO_OGUI.name(),UDO.UAV_FLIGHT_PLAN_NO_OGUI);
		outputs.put(UDO.UAV_FLIGHT_PLAN_YES_OGUI.name(),UDO.UAV_FLIGHT_PLAN_YES_OGUI);
		outputs.put(UDO.UAV_FLIGHT_PLAN_PAUSED_OGUI.name(),UDO.UAV_FLIGHT_PLAN_PAUSED_OGUI);
		outputs.put(UDO.UAV_FLIGHT_PLAN_COMPLETE_OGUI.name(),UDO.UAV_FLIGHT_PLAN_COMPLETE_OGUI);
		outputs.put(UDO.UAV_HAG_LOW_OGUI.name(),UDO.UAV_HAG_LOW_OGUI);
		outputs.put(UDO.UAV_HAG_NONE_OGUI.name(),UDO.UAV_HAG_NONE_OGUI);
		outputs.put(UDO.UAV_HAG_GOOD_OGUI.name(),UDO.UAV_HAG_GOOD_OGUI);
		outputs.put(UDO.UAV_HAG_CRASHED_OGUI.name(),UDO.UAV_HAG_CRASHED_OGUI);
		outputs.put(UDO.UAV_SIGNAL_NONE_OGUI.name(),UDO.UAV_SIGNAL_NONE_OGUI);
