...
public class OperatorGui extends Actor{
	...
	public enum VIDEO_OGUI_OP_DATA {
		OGUI_LANDED, OGUI_FLYBY_REQ_F, OGUI_FLYBY_REQ_T, VO_FLYBY_END_FAILED_VGUI, OGUI_FLYBY_END_FAILED, OGUI_FLYBY_END_SUCCESS, UAV_FLYING_NORMAL, UAV_FLYING_FLYBY
